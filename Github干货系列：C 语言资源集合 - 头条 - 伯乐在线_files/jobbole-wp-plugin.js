...
jQuery(document).ready(function ($) {
    ...
    $("#trans_article-submit-btn").bind("click",function(){
        ...
        submit_article("submit_trans_article",article_title,article_url,article_excerpt, captcha_code);
    });
    ...
    $("#article-submit-btn").bind("click",function(){
        ...
        submit_article("submit_article",article_title,article_url,article_excerpt, captcha_code);
    });
    ...
    $("#publish-to-webfront-btn").bind("click",function(){
        ...
        handle_publish_to_site(post_id,'webfront',$(this));
    });
    ...
    $("#publish-to-python-btn").bind("click",function(){
        ...
        handle_publish_to_site(post_id,'python',$(this));
    });
    ...
    $("#publish-to-ios-btn").bind("click",function(){
        ...
        handle_publish_to_site(post_id,'ios',$(this));
    });
    ...
    $("#publish-to-android-btn").bind("click",function(){
        ...
        handle_publish_to_site(post_id,'android',$(this));
    });
...
function submit_article(action_name,title, url, excerpt, captcha_code){
    if(title==='' || excerpt === ''){
        alert("请填写标题和摘要");
