(function () {
    ...
    UM.registerWidget('emotion', {
        ...
        tpl: "<link type=\"text/css\" rel=\"stylesheet\" href=\"<%=emotion_url%>emotion.css\">" +
            ...
            "<li class=\"edui-tab-item\"><a data-context=\".edui-emotion-Jtab0\" hideFocus=\"true\" class=\"edui-tab-text\"><%=lang_input_ac%></a></li>" +
            "<li class=\"edui-tab-item\"><a data-context=\".edui-emotion-Jtab1\" class=\"edui-tab-text\"><%=lang_input_ais%></a></li>" +
            "<li class=\"edui-tab-item\"><a data-context=\".edui-emotion-Jtab2\" hideFocus=\"true\" class=\"edui-tab-text\"><%=lang_input_tsj%></a></li>" +
            "<li class=\"edui-tab-item\"><a data-context=\".edui-emotion-Jtab3\" hideFocus=\"true\" class=\"edui-tab-text\"><%=lang_input_brd%></a></li>" +
            "<li class=\"edui-tab-item\"><a data-context=\".edui-emotion-Jtab4\" hideFocus=\"true\" class=\"edui-tab-text\"><%=lang_input_tdCat%></a></li>" +
        ...
        sourceData: {
            emotion: {
                tabNum: 7, //切换面板数量
                SmilmgName: { 'edui-emotion-Jtab0': ['', 54], 'edui-emotion-Jtab1': ['', 40], 'edui-emotion-Jtab2': ['', 40], 'edui-emotion-Jtab3': ['', 40], 'edui-emotion-Jtab4': ['', 40]}, //图片前缀名
                imageFolders: { 'edui-emotion-Jtab0': 'ac/', 'edui-emotion-Jtab1': 'ais/', 'edui-emotion-Jtab2': 'tsj/', 'edui-emotion-Jtab3': 'brd/', 'edui-emotion-Jtab4': 'td/'}, //图片对应文件夹路径
                imageCss: {'edui-emotion-Jtab0': 'ac', 'edui-emotion-Jtab1': 'ais', 'edui-emotion-Jtab2': 'tsj', 'edui-emotion-Jtab3': 'brd', 'edui-emotion-Jtab4': 'td'}, //图片css类名
                SmileyInfor: {
        ...
        initContent: function (_editor, $widget) {
            ...
            emotion.SmileyPath = _editor.options.emotionLocalization === true ? emotionUrl + 'images/' : "http://static.acfun.tv/dotnet/20130418/umeditor/dialogs/emotion/images/";
        ...
        mouseover: function (td, srcPath, posFlag) {
            ...
            this.previewImg.attr("src", srcPath);
        ...
        createTab: function (contentBoxId) {
            ...
            for (; i < imgNum;) {
                ...
                for (var j = 0; j < imgColNum; j++, i++) {
                    ...
                    if (faceImage) {
                        ...
                        textHTML.push('<span>');
                        textHTML.push('<img title="' + (i + 1) + '" src="' + sUrl + '"></img>');
                        textHTML.push('</span>');
                    } else {
            ...
            if (contentBoxId == 'edui-emotion-Jtab0') {

                textHTML += '<a style="color:#798;position:relative;top:10px;" href="/emot/" onclick="window.open(\'/emot/\')">AC娘表情包下载</a>'
            }
